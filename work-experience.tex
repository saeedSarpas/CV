\begin{longtable}{L{15cm} L{3.5cm}}
  ...
  \textbf{Web Developer} \desc{(Ambient Innovation, Cologne, Germany)}
  & \multirow{2}{*}{Jan 2017 --- present} \\
  \desc{Using web development technologies, such as Ruby on Rails and
    AngularJS 2, as a part-time employee my task is to develop and
    maintain web applications.} & \\

  \sep

  \textbf{Web Developer} \desc{(Appcube GbR, Bonn, Germany)}
  ...
  \textbf{Astrophysics Olympiad Teacher} \desc{(Salam Schools Complex, Tehran, Iran)}
  & \multirow{2}{*}{2010 --- 2014} \\
  \desc{} & \\
\end{longtable}